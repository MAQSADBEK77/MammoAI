...
const ru: Dictionary = {
  ...
  cycle: {
    ...
    dailyInsights: {
      phase_menstrual: { title: "Менструация", body: "Дайте телу отдохнуть — тёплое питьё и лёгкая активность полезны." },
      phase_follicular: { title: "Фолликулярная фаза", body: "Энергия растёт — хорошее время для активности." },
      phase_ovulation: { title: "Дни овуляции", body: "Фертильность на самом высоком уровне." },
      phase_luteal: { title: "Лютеиновая фаза", body: "Могут начаться симптомы ПМС — позаботьтесь о себе." },
      hydration: { title: "Не забывайте пить воду", body: "Минимум 8 стаканов воды в день важны для здоровья." },
      sleep: { title: "Качественный сон", body: "Достаточный сон помогает гормональному балансу." },
      nutrition: { title: "Сбалансированное питание", body: "Продукты, богатые железом и магнием, снижают усталость." },
      self_care: { title: "Уделите время себе", body: "Даже небольшой отдых положительно влияет на настроение." },
      ai_assistant: { title: "Есть вопрос?", body: "Спросите AI-помощника — он помнит вашу историю." },
    },
