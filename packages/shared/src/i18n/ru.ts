  ...
  checklist: {
    ...
    items: {
      ...
      prenatal_screening_stage2: {
        title: "Скрининг беременности — 2 этап (для группы риска)",
        why: "Для беременностей из группы риска пропуск этого этапа откладывает генетическую диагностику за пределы времени, когда доступны все варианты.",
      },
