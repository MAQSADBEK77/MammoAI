...
const en: Dictionary = {
  ...
  feedback: {
    ...
    premiumTitle: "Premium request",
    premiumSubtitle: "Leave a request — we'll get in touch",
    premiumPlaceholder: "You can say which feature you need (optional)",
    premiumSubmit: "Send request",
    premiumThankYou: "Request received. We'll be in touch soon.",
    ratingWorst: "Poor",
    ratingBest: "Great",
