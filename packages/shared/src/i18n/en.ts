...
const en: Dictionary = {
  ...
  community: {
    ...
    tags: {
      ...
      pregnancy: "Pregnancy",
      discharge: "Discharge and infections",
    ...
    emptyMyAnswers: "You have not answered anyone yet. Share what you know — it will help someone.",
    likeButton: "Like",
  ...
  doctorReport: {
    ...
    subtitle: "Bring it to your appointment — show it on your phone or print it",
    premiumTitle: "Report — Premium",
    premiumBody: "Your cycle history, recurring symptoms and check-ups on one page. No need to recall it all from memory at the appointment.",
    generatedOn: (date: string) => `Generated: ${date}`,
    lastPeriod: "Last period started",
    cycleLength: "Cycle length",
    cycleRange: (avg: number, min: number, max: number) => `${avg} days (${min}–${max})`,
    cyclesObserved: "Cycles observed",
    loggedDays: "Days logged",
    age: "Age",
    familyHistory: "Family cancer history",
    symptomsTitle: "Most frequent symptoms",
    days: (n: number) => `${n} days`,
    overdueTitle: "Overdue check-ups",
    completedTitle: "Completed check-ups",
    limitedDataNotice: "Fewer than 3 cycles observed so far — these figures are preliminary and not enough for reliable conclusions.",
