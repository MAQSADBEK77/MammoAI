    ...
    <div className="flex min-h-full flex-col bg-slate-50 dark:bg-slate-950">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-14 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-slate-900 dark:text-white sm:text-3xl">{t.faqPage.title}</h1>
          ...
          {items.map((item) => {
            ...
            return (
              <Card key={item.id} className="p-5">
                <h2 className="font-semibold text-slate-900 dark:text-white">{l.question}</h2>
