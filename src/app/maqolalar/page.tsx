    ...
    <div className="flex min-h-full flex-col bg-slate-50 dark:bg-slate-950">
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-14 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold text-pink-900 dark:text-white sm:text-3xl">{t.articlesPage.title}</h1>
          ...
          {articles.map((a) => (
            <Link key={a.id} href={`/maqolalar/${a.slug}`}>
              <Card className="p-5 transition-shadow hover:shadow-md">
                ...
                <h2 className="mt-1 font-semibold text-pink-900 dark:text-white">{a.title}</h2>
